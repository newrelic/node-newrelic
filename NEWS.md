...
* Add ai_monitoring configuration ([#1873](https://github.com/newrelic/node-newrelic/pull/1873)) ([52bf9f3](https://github.com/newrelic/node-newrelic/commit/52bf9f362884f481a6dcc955be4fb1267458def8))
* Add version tracking metric on OpenAI events ([#1886](https://github.com/newrelic/node-newrelic/pull/1886)) ([d11d100](https://github.com/newrelic/node-newrelic/commit/d11d100a37ad04201a9065363b1bc6b2d6fe36f2))
* Added API for tracking LLM feedback ([#1868](https://github.com/newrelic/node-newrelic/pull/1868)) ([1681e4b](https://github.com/newrelic/node-newrelic/commit/1681e4bbaa60264a0638790424d3e5370b1ee7bf))
* Added configuration for openai instrumentation ([#1856](https://github.com/newrelic/node-newrelic/pull/1856)) ([08b5a78](https://github.com/newrelic/node-newrelic/commit/08b5a782208e35adf3917221eac86acdf4a6e900))
...
* Add missing configuration check in OpenAI implementation ([#1875](https://github.com/newrelic/node-newrelic/pull/1875)) ([039705f](https://github.com/newrelic/node-newrelic/commit/039705ff54b80c7e5d9d11ffd65b24307d6b6318))
...
* updated how completion_id is assigned to LlmCompletionMessage ([#1874](https://github.com/newrelic/node-newrelic/pull/1874)) ([ee809ff](https://github.com/newrelic/node-newrelic/commit/ee809ff0f94f6b43580a0e51f757c45258f6252d))
* Updated LLM events to no longer serialize and just return object ([#1869](https://github.com/newrelic/node-newrelic/pull/1869)) ([980f4d2](https://github.com/newrelic/node-newrelic/commit/980f4d2a19b3162511f61f19bcbce8c77d54c79a))
...
* **docs:** Updated links in documentation to https ([#1888](https://github.com/newrelic/node-newrelic/pull/1888)) ([f1913ea](https://github.com/newrelic/node-newrelic/commit/f1913ea9aff12051167e11b2c3ca899a5e8324fc))
    * Signed-off-by: mrickard <maurice@mauricerickard.com>
* fix bool -> boolean in jsdoc ([#1853](https://github.com/newrelic/node-newrelic/pull/1853)) ([3c00e55](https://github.com/newrelic/node-newrelic/commit/3c00e55291ef8a54e64339519700384c06cc5d71))

#### Tests

* Add streaming responses to mock OpenAI sever ([#1881](https://github.com/newrelic/node-newrelic/pull/1881)) ([86d83f2](https://github.com/newrelic/node-newrelic/commit/86d83f20028ec8a135241d4ad92032488ff5ad3a))
* Add unit tests for LLM API methods ([#1878](https://github.com/newrelic/node-newrelic/pull/1878)) ([3d8b987](https://github.com/newrelic/node-newrelic/commit/3d8b987408512e0643b4daed078a6fd7ebe363ca))
...
* Make release note date always in pacific time ([#1855](https://github.com/newrelic/node-newrelic/pull/1855)) ([6d7dc69](https://github.com/newrelic/node-newrelic/commit/6d7dc69ccb71b2778da28598c50b65842ac4e3f7))
