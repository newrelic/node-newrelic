...
var loadInstrumentationFile = function loadInstrumentationFile(agent,
                                                               shortName,
                                                               fileName,
                                                               nodule) {
...
var shimmer = module.exports = {
  ...
  /**
   * Load all of the core instrumentation up front. These are always available,
   * they're pretty much always used, and we might not see the modules load
   * through our module patching.
   *
   */
  bootstrapInstrumentation : function bootstrapInstrumentation(agent) {
    ...
    files.forEach(function (name) {
      ...
      loadInstrumentationFile(agent, name, fileName,
                              require(path.basename(name, ".js")));
    });
  }
};
