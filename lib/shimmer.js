...
function instrument(agent, nodule, moduleName, resolvedName) {
  ...
  var shim = shimmer.createShimFromType(instrumentation.type, agent, moduleName, resolvedName)
...
var shimmer = module.exports = {
  ...
  createShimFromType: function createShimFromType(type, agent, moduleName, resolvedName) {
    var shim = null
