...
var CORE_INSTRUMENTATION = {
  ...
  dns: {                  // instrumentations are run at startup by requiring
    type: MODULE_TYPE.GENERIC,      // each of their modules. Loading `domain` has side
    file: 'dns.js'        // effects that we should try to avoid.
  },
  fs: {
    type: MODULE_TYPE.GENERIC,
    file: 'fs.js'
