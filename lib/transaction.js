...
Transaction.prototype.measureWeb = function (requestURL,
  ...
  if (name && name.ignore) {
    ...
    metrics.measureDuration(NAMES.WEB,  null, duration);
    metrics.measureDuration(NAMES.HTTP, null, duration);
    ...
    metrics.measureDuration(this.scope, null, duration, maxDuration);
