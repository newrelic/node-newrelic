...
/**
 * Given an accumulator and a new interval to fold into it, figure out if it's
 * a sub-interval (in which case it's discarded), an overlapping interval (in
 * which case, replace it with an extended interval), or otherwise (it's disjoint,
 * in which case add it to the list. Meant to be used with Array.reduce()
 *
