...
function Metrics(renamer, apdexT, normalizer) {
...
Metrics.prototype.recordWebTransaction = function (requestUri,
                                                   durationInMillis,
  ...
  if (responseStatusCode === 414 || // Request-URI Too Long
    ...
    var normalizedUrl = this.normalizer.normalizeUrl(requestUri);
    if (normalizedUrl) {
