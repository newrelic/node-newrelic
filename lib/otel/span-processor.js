...
module.exports = class NrSpanProcessor {
  ...
  reconcileProducerAttributes({ segment, span }) {
    const mapper ={
      ...
      // TODO: double check the following gcp attributes
      [ATTR_GCP_PROJECT_ID]: (value) => segment.addAttribute('gcp.project_id', value),
      [ATTR_MESSAGING_BATCH_MESSAGE_COUNT]: (value) => segment.addAttribute('message.count', value),
      [ATTR_MESSAGING_DESTINATION_NAME]: (value) => segment.addAttribute('message.topicName', value),
    }
