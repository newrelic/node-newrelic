...
class SegmentSynthesizer {
  ...
  synthesize(otelSpan) {
    ...
    switch (rule.type) {
      case 'consumer': {
        return createConsumerSegment(this.agent, otelSpan, rule.name)
      }

      case 'db': {
        return createDbSegment(this.agent, otelSpan, rule.name)
      }
      ...
      case 'internal': {
        return createInternalSegment(this.agent, otelSpan, rule.name)
      }

      case 'producer': {
        return createProducerSegment(this.agent, otelSpan, rule.name)
      }

      case 'server': {
        return createServerSegment(this.agent, otelSpan, rule.name)
      }
