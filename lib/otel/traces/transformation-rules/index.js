 ...
 * - 300-399: Database rules (no fallback)
 * - 400-499: Client/External rules (fallback at 499)
 * - 500-599: Producer rules (fallback at 599)
 * - 999: Internal fallback rule
 *
 * Within each category, rules are ordered from most specific to least specific,
 * with type-specific fallback rules positioned at X99 (e.g., 199, 299, 499, 599).
