...
/**
 * Basic sampler that just checks if there is an active transaction. If not, it falls back to checking if it is a server of consumer span or `isRemote` exists on the parent span context.
 */
