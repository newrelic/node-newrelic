            ...
            return function wrapQuery() {
              ...
              if (typeof last === 'function') {
                args[pos] = tracer.callbackProxy(function cb_pgquery() {
                  ...
                  segment.end()
                  logger.trace("postgres command trace segment ended by callback for transaction %d.",
                               transaction.id)
                })
              }
              ...
              var end = tracer.callbackProxy(function end() {
                segment.end()
                logger.trace("postgres command trace segment ended by event for transaction %d.",
                             transaction.id)
              })
