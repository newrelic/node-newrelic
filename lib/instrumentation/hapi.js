...
function wrapServer(shim, Server) {
  // wrap Server.prototype.start in order to set dispatcher
  var setDispatcher = shim.once(shim.setDispatcher)
  shim.wrap(Server.prototype, 'start', function wrapStart(shim, original) {
  ...
  shim.wrap(Server.prototype, 'route', function wrapRoute(shim, original) {
    return function wrappedRoute() {
      ...
      function wrapRoute(shim, route, path) {
        shim.wrap(route, 'handler', function wrapHandler(shim, original) {
