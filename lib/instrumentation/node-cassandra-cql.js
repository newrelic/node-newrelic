...
<<<<<<< HEAD
  'prepare',
=======
>>>>>>> 344f8a8190c4768f518eb87019b0a7fc0787c252
  'executeBatch'
];
...
<<<<<<< HEAD
  var lastPreparedStatement = ""; // `executePrepared` *should* always be executed immediately following a `prepare`
=======
>>>>>>> 344f8a8190c4768f518eb87019b0a7fc0787c252
...
<<<<<<< HEAD
          if (operation === "prepare") {
            lastPreparedStatement = cql;
            return cmd.apply(this, arguments);
          }

          var transaction = tracer.getTransaction()
            , args = tracer.slice(arguments)
            , name = operation === "executePrepared"
              ? CASSANDRA.STATEMENT + lastPreparedStatement
