...
function initialize(agent, mongodb, moduleName, shim) {
  if (!mongodb) return
  var recordDesc = {
    'GridStore': {isQuery: false,
      makeDesc: function(opName) { return {name:'GridFS-' + opName, callback: shim.LAST} }},
    ...
    'Db': {isQuery: false, makeDesc: function() { return {callback: shim.LAST} }}
  }
