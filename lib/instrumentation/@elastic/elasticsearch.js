...
function queryParser(params) {
  ...
  if (
    ...
    typeof params.bulkBody === 'object' &&
    params.body !== null &&
    Object.keys(params.bulkBody).length > 0
  ) {
 ...
 * @param {string} pkgVersion elasticSearch version, derived from package.json
 * @returns {Function} captureInstanceAttributes method of shim
 */
function getConnection(shim, pkgVersion) {
  if (semver.gte(pkgVersion, '7.16.0')) {
