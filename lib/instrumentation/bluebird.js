...
var BLUEBIRD_SPEC = {
  ...
  $proto: {
    cast: [
      'return', 'throw', 'catchReturn', 'catchThrow', 'delay',
      'thenReturn', 'thenThrow', 'call', 'all', 'any', 'bind', 'get',
      'props','reflect','race', 'some', 'timeout'
    ],
    then: [
      'asCallback', 'done', 'each', 'filter', 'finally', 'lastly',
      'map', 'mapSeries', 'nodeify', 'reduce', 'spread', 'tap',
      'tapCatch', 'then'
    ],
