...
var BLUEBIRD_SPEC = {
  ...
  $proto: {
    then: [
      'all', 'any', 'asCallback', 'bind', 'call', 'catchReturn', 'catchThrow',
      'delay', 'done', 'each', 'filter', 'finally', 'get', 'lastly', 'map',
      'mapSeries', 'nodeify', 'props', 'race', 'reduce', 'reflect', 'return',
      'some', 'spread', 'tap', 'tapCatch', 'then', 'thenReturn', 'thenThrow',
      'timeout', 'throw'
    ],
