...
module.exports = function addUndiciChannels(agent, _undici, _modName, shim) {
  diagnosticsChannel.subscribe('undici:request:create', requestCreateHook.bind(null, shim))
  diagnosticsChannel.subscribe('undici:request:headers', requestHeadersHook.bind(null, shim))
  diagnosticsChannel.subscribe('undici:request:trailers', endAndRestoreSegment.bind(null, shim))
  diagnosticsChannel.subscribe('undici:request:error', endAndRestoreSegment.bind(null, shim))
}
