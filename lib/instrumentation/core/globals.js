...
function initialize(agent) {
  ...
  // `uncaughtException`.
  shimmer.wrapMethod(process, 'process', '_fatalException', wrapExceptionHandler)
  ...
  shimmer.wrapMethod(
    ...
    wrapExceptionHandler
  )

  function wrapExceptionHandler(original) {
    return function wrappedExceptionHandler(error) {
