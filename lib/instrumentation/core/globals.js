...
function initialize(agent) {
  ...
  // Promises don't exist prior to version 0.12, and we want to default
  // to using async hooks if they are available.
  var usingAsyncHook = agent.config.checkAsyncHookStatus()
  if (semver.satisfies(process.version, '>=0.12') && !usingAsyncHook) {
