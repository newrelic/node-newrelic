...
module.exports = function initialize(agent, http) {
  ...
  shimmer.wrapMethod(http, 'http', 'createServer', function (original) {
    return function (cb) {
      ...
      return original.call(this, function (request, response) {
        ...
        if (request.url !== '/favicon.ico') {
          ...
          shimmer.wrapMethod(response, 'response', 'end', function (original) {
            return function () {
              original.apply(this, arguments);
              /*
               * Node's http library only offers a status code, not
               * a textual message.
               */
              probe.end();
