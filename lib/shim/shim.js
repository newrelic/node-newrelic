...
defineProperties(Shim.prototype, {
   ...
   *
   * @readonly
   * @member {Function} Shim.prototype.tracer
   * @returns {Function} The agent's instance of the tracer
   */
...
function record(nodule, properties, recordNamer) {
  ...
  return this.wrap(nodule, properties, function makeWrapper(shim, fn, name) {
    ...
    /**
     * @param {TraceSegment} segment The trace segment to be recorded
     * @param {Array} args The arguments to the wrapped callback
     * @param {Spec} segDesc Segment descriptor spec
     * @param {boolean} shouldCreateSegment Whether the recorder should create a segment
    ...
    /**
     * @param {TraceSegment} segment The trace segment being applied to the wrapped function
     * @param {context} ctx Context sjupplied to
     * @param args
     * @param segDesc
     */
