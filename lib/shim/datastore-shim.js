...
function captureInstanceAttributes(host, port, database) {
  ...
  var extras = _normalizeExtras.call(this, {
    host: host,
  ...
  Object.keys(extras).forEach(function forEachExtraKey(key) {
    segment.parameters[key] = extras[key]
  })
}
  ...
  return this.record(nodule, properties, function queryRecord(shim, fn, fnName, args) {
    ...
    if (queryDesc.hasOwnProperty('record') && queryDesc.record === false) {
      return {
        ...
        callback:     queryDesc.callback      || null,
        rowCallback:  queryDesc.rowCallback   || null,
        stream:       queryDesc.stream        || null,
        internal:     queryDesc.internal      || false,
      }
    }
    ...
    return {
      ...
      rowCallback:  queryDesc.rowCallback   || null,
      stream:       queryDesc.stream        || null,
      internal:     queryDesc.internal      || true,
 ...
 * @this DatastoreShim
 *
 * @param {object} [extras={}] - The segment parameters to clean up.
 *
 * @return {object} - The normalized segment parameters.
 */
function _normalizeExtras(extras) {
  extras = extras || {}
  ...
  if (!dsTracerConf.instance_reporting.enabled) {
    ...
    if (extras.hasOwnProperty('host')) {
      ...
      if (!extras.host || extras.host === 'UNKNOWN_BOX') {
        extras.host = INSTANCE_UNKNOWN
      }
    }
  }
