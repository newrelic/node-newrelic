...
var MIDDLEWARE_TYPE_DETAILS = {
  APPLICATION: {name: 'Mounted App: ', record: false},
  ENDPOINT: {name: 'Route Path: ', record: false},
  ERRORWARE: {name: null, record: true},
  MIDDLEWARE: {name: null, record: true},
  PARAMWARE: {name: 'Param Handler: ', record: true},
  ROUTER: {name: 'Router: ', record: false}
}
...
function _recordMiddleware(shim, middleware, type, route, spec) {
  ...
  // console.log(segmentName, spec.name, shim.getName(middleware))
