...
const DISTRIBUTED_TRACE_HEADER = 'X-NewRelic-Trace'
var HTTP_CAT_ID_HEADER = 'X-NewRelic-Id'
var MQ_CAT_ID_HEADER = 'NewRelicID'
var MATCH_CAT_ID_HEADER = new RegExp(
  '^(?:' + HTTP_CAT_ID_HEADER + '|' + MQ_CAT_ID_HEADER + ')$',
  'i'
)
var HTTP_CAT_TRANSACTION_HEADER = 'X-NewRelic-Transaction'
var MQ_CAT_TRANSACTION_HEADER = 'NewRelicTransaction'
var MATCH_CAT_TRANSACTION_HEADER = new RegExp(
  '^(?:' + HTTP_CAT_TRANSACTION_HEADER + '|' + MQ_CAT_TRANSACTION_HEADER + ')$',
  'i'
)
var HTTP_CAT_APP_DATA_HEADER = 'X-NewRelic-App-Data'
var MQ_CAT_APP_DATA_HEADER = 'NewRelicAppData'
