...
function recordMiddleware(nodule, properties, spec) {
  ...
  const mwSpec = new specs.SpecMiddleware(spec)
  const wrapSpec = new specs.SpecWrap(function wrapMiddleware(shim, middleware) {
...
function recordParamware(nodule, properties, spec) {
  ...
  const wrapSpec = new specs.SpecWrap(function wrapParamware(shim, middleware, name) {
    mwSpec.name = name
    return _recordMiddleware(shim, middleware, mwSpec)
  })
