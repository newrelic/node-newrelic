...
for (const [fwName, fw] of Object.entries(FRAMEWORK_NAMES)) {
  Shim.defineProperty(WebFrameworkShim, fwName, fw)
  Shim.defineProperty(WebFrameworkShim.prototype, fwName, fw)
}

WebFrameworkShim.MIDDLEWARE_TYPE_NAMES = MIDDLEWARE_TYPE_NAMES
for (const [mtName, mType] of Object.entries(MIDDLEWARE_TYPE_NAMES)) {
  Shim.defineProperty(WebFrameworkShim, mtName, mType)
  Shim.defineProperty(WebFrameworkShim.prototype, mtName, mType)
}
