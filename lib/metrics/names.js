...
const INFINITE_TRACING = {
  ...
  SPAN_RESPONSE_UNIMPLEMENTED: SUPPORTABILITY.INFINITE_TRACING + '/Span/gRPC/UNIMPLEMENTED',
  SPAN_RESPONSE_ERROR_STATUS: SUPPORTABILITY.INFINITE_TRACING + '/Span/gRPC/%s',
