...
const STREAMING_SPAN_EVENTS = {
  SEEN: SUPPORTABILITY.PREFIX + 'InfiniteTracing/Span/Seen',
  SENT: SUPPORTABILITY.PREFIX + 'InfiniteTracing/Span/Sent'
}

const INFINITE_TRACING = {
  MALFORMED_TRACE_OBSERVER: SUPPORTABILITY.INFINITE_TRACING + '/MalformedTraceObserver',
  SPAN_RESPONSE_ERROR: SUPPORTABILITY.INFINITE_TRACING + '/Span/Response/Error/%s'
}
...
module.exports = {
  ...
  STREAMING_SPAN_EVENTS: STREAMING_SPAN_EVENTS,
