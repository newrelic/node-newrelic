...
const SAMPLERS = {
  ROOT: '/Root',
  SAMPLED: '/RemoteParentSampled',
  NOT_SAMPLED: '/RemoteParentNotSampled'
}

SAMPLERS.FULL = {
  ROOT: FULL_TRACE_PREFIX + SAMPLERS.ROOT,
  SAMPLED: FULL_TRACE_PREFIX + SAMPLERS.SAMPLED,
  NOT_SAMPLED: FULL_TRACE_PREFIX + SAMPLERS.NOT_SAMPLED
}

SAMPLERS.PARTIAL = {
  ROOT: PARTIAL_TRACE.PREFIX + SAMPLERS.ROOT,
  SAMPLED: PARTIAL_TRACE.PREFIX + SAMPLERS.SAMPLED,
  NOT_SAMPLED: PARTIAL_TRACE.PREFIX + SAMPLERS.NOT_SAMPLED
}
