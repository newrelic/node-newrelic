 ...
 * @property {string|undefined} queue The name of the target queue from which
 * messages will be consumed. This is likely set in an extension class when the
 * consumer function starts.
 */
