...
const legacySendConfig = {
  ...
  instrumentations: [
    ...
    {
      channelName: 'nr_send',
      module: { name: '@aws-sdk/smithy-client', versionRange: '>=3.35.0', filePath: 'dist-cjs/client.js' },
      functionQuery: {
        className: 'Client',
        methodName: 'send',
        kind: 'Sync'
    ...
    {
      channelName: 'nr_send',
      module: { name: '@aws-sdk/smithy-client', versionRange: '>=3.35.0', filePath: 'dist-es/client.js' },
      functionQuery: {
        className: 'Client',
        methodName: 'send',
        kind: 'Sync'
