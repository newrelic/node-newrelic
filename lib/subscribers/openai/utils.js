 ...
 * @param {Transaction} params.transaction active transaction
 * @param {number} params.inputTimestamp timestamp captured at the time of the LLM request with millisecond precision
 */
 ...
 * @param {number} params.inputTimestamp timestamp captured at the time of the LLM request with millisecond precision
 */
function instrumentStream({ agent, headers, logger, request, response, segment, transaction, err = null, inputTimestamp }) {
