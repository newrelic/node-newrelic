...
class KoaMiddlewareWrapper extends MiddlewareWrapper {
   ...
   * A handler means it is the final middleware for a given router instance
   *
   ...
   * @param {boolean} params.isHandler flag to indicate the middleware is the final one in a router
   */
  wrapDoneHandler({ route, isHandler, ctx, args }) {
