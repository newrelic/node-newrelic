...
// TODO: I am unsure if the below configs are necessary,
// but the shim-based instrumentation wrapped them, most
// likely for its own context preservation.

const poolClusterGetConnection = {
  path: './mysql/poolCluster-getConnection.js',
  instrumentations: [
    {
      channelName: 'nr_poolClusterGetConnection',
      module: { name: 'mysql', versionRange: '>=2.16.0', filePath: 'lib/PoolCluster.js' },
      functionQuery: {
        moduleName: 'PoolCluster',
        expressionName: 'getConnection',
        kind: 'Sync'
      }
    }
...
const poolClusterOf = {
  path: './mysql/poolCluster-of.js',
  instrumentations: [
    {
      channelName: 'nr_poolClusterOf',
      module: { name: 'mysql', versionRange: '>=2.16.0', filePath: 'lib/PoolCluster.js' },
      functionQuery: {
        moduleName: 'PoolCluster',
        expressionName: 'of',
