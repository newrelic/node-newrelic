...
/**
 * Subscribes to the `_innerExecute` event in `cassandra-driver`'s
 * `Client` and extracts relevant information from the query.
 */
class CassandraInnerExecuteSubscriber extends DbQuerySubscriber {
  constructor({ agent, logger }) {
    super({ agent, logger, channelName: 'nr__innerExecute', packageName: 'cassandra-driver', system: 'Cassandra' })
...
module.exports = CassandraInnerExecuteSubscriber
