...
/**
 * @property {boolean} [opaque=false] Should be set if the segments within the
 * transaction should be omitted.
 * @property {string} queryString Must be set by any class that extends this
 * one prior to this class's `.handler` method being invoked.
 */
