...
class SpanEvent {
  ...
  static fromSegment(segment, parentId, grandparentId) {
    ...
    if (span.parentId && span.parentId === span.transactionId) {
...
class DatastoreSpanEvent extends SpanEvent {
  constructor(parameters) {
    ...
    if (parameters.collection) {
      this['db.statement'] = parameters.collection
    }
    if (parameters.operation) {
      this['db.instance'] = parameters.operation
    }
    if (parameters.host) {
    ...
    if (parameters.database_name) {
      this['span.kind'] = parameters.database_name
    }
  }
