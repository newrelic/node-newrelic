...
class StreamingSpanEvent {
  ...
  constructor(traceId, agentAttributes, customAttributes) {
    ...
    this._intrinsicAttributes = new StreamingAttributes()
    ...
    this._customAttributes = new StreamingAttributes(customAttributes)
    this._agentAttributes = new StreamingAttributes(agentAttributes)
  }
