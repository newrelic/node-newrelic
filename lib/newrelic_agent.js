...
if (module.newrelic_agent != null) {
	return module.newrelic_agent;
}
...
//	    ]
	...
	this.connect = function(licenseKey, host, port) {
		nrService = service.createNewRelicService(licenseKey, host, port);
	...
	*/
	...
	function loadInstrumentation() {
		...
		for (var i = 0; i < files.length; i++) {
			var inst = require("newrelic_agent/" + coreDir + "/" + files[i]);
