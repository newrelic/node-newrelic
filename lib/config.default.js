...
exports.config = {
  ...
  logging: {
     ...
     * This field is ignored if trace level logging is enabled. With trace logging, all traffic is logged
     *
     ...
     * Otherwise, if the audit log is enabled, only the methods specified in the filter will be logged
     * Methods include: error_data, metric_data, transaction_sample_data, and analytic_event_data
     *
     * @env NEW_RELIC_AUDIT_METHOD_FILTER
     */
