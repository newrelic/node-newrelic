...
class AwsLambda {
  ...
  patchLambdaHandler(handler) {
    ...
    const isStreamHandler = handler[Symbol.for('aws.lambda.runtime.handler.streaming')] === 'response'
    ...
    function wrappedHandler() {
      ...
      logger.trace('wrapped handler args', args)
      ...
      if (typeof context === 'function') {
        logger.trace('context is a function here', context.toString())
      }
      ...
      logger.trace('Is there an active segment?', activeSegment)
      ...
      logger.trace(`creating segment for function named ${functionName}`)
