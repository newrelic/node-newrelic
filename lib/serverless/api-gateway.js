 ...
 * @param {Set} requiredKeys A set of keys unique to this proxy type
 * @returns {boolean} Whether this event has matches for the keys we're checking
 */
function eventHasRequiredKeys(targetEvent, requiredKeys) {
  const targetKeys = new Set(Object.keys(targetEvent))
  return requiredKeys.isSubsetOf(targetKeys)
}

// See https://docs.aws.amazon.com/apigateway/latest/developerguide/set-up-lambda-proxy-integrations.html#api-gateway-simple-proxy-for-lambda-input-format
const requiredHttpApiV1Keys = new Set([
  'httpMethod',
  'path',
  'resource',
  'multiValueHeaders',
...
// See https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-develop-integrations-lambda.html
const requiredHttpApiV2Keys = new Set(['rawPath', 'rawQueryString', 'routeKey'])
