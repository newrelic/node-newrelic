...
Logger.prototype.child = function child(extra) {
  ...
  childLogger.extra = Object.assign(Object.create(null), this.extra)
  Object.assign(childLogger.extra, extra)
  ...
  childLogger.write = function write(level, args, _extra) {
    ...
    var selfExtra = Object.assign(Object.create(null), this.extra)

    _extra = Object.assign(selfExtra, _extra)
...
Logger.prototype.write = function write(level, args, extra) {
  ...
  Object.assign(entry, this.extra)
  Object.assign(entry, getPropertiesToLog(extra))
