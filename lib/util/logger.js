...
Logger.prototype.child = function child(extra) {
  ...
  childLogger.extra = util._extend(Object.create(null), this.extra)
  ...
  childLogger.write = function write(level, args, _extra) {
    ...
    var selfExtra = util._extend(Object.create(null), this.extra)
...
function getPropertiesToLog(extra) {
  var obj = util._extend(Object.create(null), extra)
