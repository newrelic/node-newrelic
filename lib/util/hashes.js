...
function calculatePathHash(appName, pathName, referringPathHash) {
  if (typeof referringPathHash === 'string') {
    referringPathHash = parseInt(referringPathHash, 16)
  }
  const rotated = ((referringPathHash << 1) | (referringPathHash >>> 31)) >>> 0
