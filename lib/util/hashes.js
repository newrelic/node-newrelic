...
// TODO: Just use Buffer.from once Node <5.10.0 is deprecated. Also need to account for node <4.4 vs. 4.5+ Buffer.from
var makeBuffer = process.versions.node >= '4.5.0' ? Buffer.from : function makeBuffer(v, enc) {
