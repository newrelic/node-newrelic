...
// Also need to account for node <4.4 vs. 4.5+ Buffer.from
var makeBuffer = process.versions.node >= '4.5.0' ? Buffer.from : bufferShim

function bufferShim(v, enc) {
  return new Buffer.Buffer(v, enc)
}
