...
Transaction.prototype._markAsWeb = function _markAsWeb(rawURL) {
  ...
  // multiple params places.
  var params = util._extend({}, this.trace.attributes.get('transaction_tracer'))
  ...
  // TODO: In v3, these parameters should be prefixed with `request.parameters.`
  urltils.copyParameters(urltils.parseParameters(rawURL), params)
