...
function finalizeNameFromUri(requestURL, statusCode) {
  ...
  // Note: can't move this to wrapEmitWithTransaction because our tests call this
  // function directly and require the scrubbing here.
...
Transaction.prototype.getName = function getName() {
  if (this.isWeb() && this.url) {
    const url = this.parsedUrl || this.url
