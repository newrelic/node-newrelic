...
/**
 * Gets the guid of the currently active distributed trace span
 */
Transaction.prototype.getSpanId = function getSpanId() {
  let segment = this.agent.tracer.getSegment()
  if (!segment) {
    return null
  }
