...
// Transaction.prototype.traceparentSampledDecision = function traceparentSampledDecision() {
//   const remoteSampled = this.agent.config.distributed_tracing.sampler.remote_parent_sampled
//
//   switch (remoteSampled) {
//     case 'always_on': {
//       return 2.0
//     }
//
...
// }
//
// Transaction.prototype.useTraceparent = function useTraceparent() {
//   const parentSampled = this.agent.config.distributed_tracing.sampler.remote_parent_sampled
//   const stateSampled = this.agent.config.distributed_tracing.sampler.remote_parent_not_sampled
//
//   if (parentSampled === 'always_on') {
//     return true
//   }
//
//   if (parentSampled === 'always_off') {}
// }
