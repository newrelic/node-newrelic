...
/**
 * @returns {boolean} Whether this transaction should be ignored.
 */
Transaction.prototype.isIgnored = function isIgnored() {
  return this.ignore === true || this.forceIgnore === true
}
