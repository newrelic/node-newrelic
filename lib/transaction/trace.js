 ...
 *                            scope.
 */
Trace.prototype.addRecorder = function (recorder) {
  this.recorders.push(recorder);
};

/**
 * Run the metrics recorders for this trace. If the transaction's name /
 * scope hasn't been set yet, the recorder will be passed an undefined scope,
 * and should be written to handle this.
 */
Trace.prototype.record = function () {
  var scope = this.transaction.scope;
  this.recorders.forEach(function (recorder) { recorder(scope); }.bind(this));
};
