...
function TraceSegment(transaction, name, recorder) {
  ...
  // 64 item limit for custom attributes
  this.customAttributes = new Attributes(ATTRIBUTE_SCOPE, 64)
...
TraceSegment.prototype.getCustomAttributes = function getCustomAttributes() {
  return this.customAttributes.get(DESTINATIONS.TRANS_SEGMENT)
}
