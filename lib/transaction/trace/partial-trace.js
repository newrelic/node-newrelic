...
class PartialTrace {
  ...
  /**
   * Iterates over the span links from a drop span and reassigns them to the last kept span.
   * The id intrinsic attribute will also be updated to the value of the last kep span id.
   *
  ...
  reparentSpanLinks(spanLinks) {
    ...
    // the id instinsics attribute needs to be updated to equal the id of the new span the
    ...
    this.spans[this.spans.length - 1].spanLinks = [...lastSpan.spanLinks, ...spanLinks]
  }
