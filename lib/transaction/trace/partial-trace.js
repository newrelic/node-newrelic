...
class PartialTrace {
   ...
   */
  generateSpans() {
    this.transaction.trace.generateSpans(this.transaction.trace.segments.root)
    this.finalize()
  }
   ...
   *
   * @param {Span} span the span to reparent span links to
   ...
   * @param {Span} span an exit span to the same entity as retained span
   */
   ...
   *
   * @param {Span} span to check if it has to calculate `nr.durations` and `nr.ids`
   */
