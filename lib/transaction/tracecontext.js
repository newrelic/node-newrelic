...
class TraceContext {
   ...
   * @property {boolean} entryFound - Whether a New Relic tracestate string is found
   * @property {boolean} entryValid - Whether the New Relic tracestate string is valid
