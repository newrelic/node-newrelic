...
class ErrorCollector {
  ...
  addUserError(transaction, error, customAttributes) {
    ...
    if (transaction) {
      ...
      this._collect(transaction, exception)
    }
  }
   ...
   * @return {bool} Whether the error was collected.
   */
  collect(transaction, exception) {
    ...
    if (errorHelper.shouldIgnoreError(transaction, exception.error, this.config)) {
