...
function createError(transaction, exception, customParameters) {
  ...
  if (customParameters) {
    ...
    Object.keys(customParameters).forEach(function (param) {
 ...
 * little as possible.
 */
ErrorTracer.prototype.onTransactionFinished = function (transaction, metrics) {
 ...
 *                                       the request (optional).
 */
ErrorTracer.prototype.add = function (transaction, exception, customParameters) {
  if (!exception) {
