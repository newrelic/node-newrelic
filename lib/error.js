...
ErrorTracer.prototype.add = function (transaction, exception) {
  ...
  if (exception) {
    if (exception.__NR_CAUGHT) return;
 ...
 * @param Function original The wrapped call.
 * @param object context The user context for the call.
 * @param array args Either a copy of the functions arguments object or whatever
 *                   the instrumentation generates.
 */
ErrorTracer.prototype.monitor = function (transaction, original, context, args) {
  if (typeof original !== 'function') {
    throw new Error("2nd parameter of monitor must be a function!");
  }
