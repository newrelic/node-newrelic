...
function Config(config) {
  ...
  this.run_id = null
  this.account_id = this.distributed_tracing.account_id
  this.application_id = null
  this.web_transactions_apdex = Object.create(null)
  this.cross_process_id = null
  this.encoding_key = null
  this.obfuscatedId = null
  this.primary_application_id = this.distributed_tracing.primary_application_id
  this.trusted_account_ids = null
  this.trusted_account_key = this.distributed_tracing.trusted_account_key
...
// These 3 getter-setters are to support the new local configuration
// e.g. account_id is now distributed_tracing.account_id, but
// the server still sends it as account_id.
Object.defineProperty(Config.prototype, 'primary_application_id', {
  get: function () {
    return this.distributed_tracing.primary_application_id
  },
  set: function (value) {
    this.distributed_tracing.primary_application_id = value
    this.emit('primary_application_id', value)
  }
})

Object.defineProperty(Config.prototype, 'account_id', {
  get: function () {
    return this.distributed_tracing.account_id
  },
  set: function (value) {
    this.distributed_tracing.account_id = value
    this.emit('account_id', value)
  }
})

Object.defineProperty(Config.prototype, 'trusted_account_key', {
  get: function () {
    return this.distributed_tracing.trusted_account_key
  },
  set: function (value) {
    this.distributed_tracing.trusted_account_key = value
    this.emit('trusted_account_key', value)
  }
})
...
/**
 * Disables DT if `distributed_tracing.account_id` is not set.
 * Otherwise it will set `distributed_tracing.trusted_account_key`
 * and `distributed_tracing.primary_application_id` accordingly.
 *
 * @returns {void}
 */
Config.prototype._serverlessDT = function _serverlessDT() {
  if (!this.distributed_tracing.account_id) {
    ...
    this.distributed_tracing.trusted_account_key =
      this.distributed_tracing.trusted_account_key || this.distributed_tracing.account_id

    // Not required in serverless mode but must default to Unknown to function.
    this.distributed_tracing.primary_application_id =
      this.distributed_tracing.primary_application_id || 'Unknown'
  }
}
