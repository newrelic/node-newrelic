...
/**
 * Renders a schema node into its default value: a terminal node's own
 * `default`, or, for an object node, an object of its properties' rendered
 * defaults. Returns `undefined` for nodes with no default (including
 * `oneOf`/`anyOf` nodes, whose default, if any, lives on the node itself).
 *
 ...
 * @param {boolean} [params.rebuildCache] When `true`, do not return the cached
...
function generateDefaultConfig({
  ...
  if (cached !== undefined && rebuildCache === false) return cached
