...
defaultConfig.definition = () => ({
  ...
  opentelemetry: {
    /**
     * `bridge` is a global switch. If it is set to `false`, any other
     * sub-feature, e.g. `traces`, will not be enabled regardless of that
     * specific sub-feature setting.
     *
     * NOTICE: while the feature flag is still present, both the feature
     * flag and this setting must be set to `true` in order to enable
     * the bridge.
     */
    bridge: {
