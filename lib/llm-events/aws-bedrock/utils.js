...
function tokenUsageAttributesExist(response) {
  const tokensExistA = response?.usage?.input_tokens && response?.usage?.output_tokens && response?.usage?.total_tokens
  const tokensExistB = response?.usage?.inputTokens && response?.usage?.outputTokens && response?.usage?.totalTokens
...
function tokenUsageHeadersExist(response) {
  return (
    response?.headers['x-amzn-bedrock-input-token-count'] &&
    response?.headers['x-amzn-bedrock-output-token-count'] &&
