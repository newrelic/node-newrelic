...
// Assuming utils.js exists and contains stringifyClaudeChunkedMessage and stringifyConverseChunkedMessage
 ...
 * unifying logic for both InvokeModelCommand and ConverseCommand inputs.
 */
class BedrockCommand {
  #input // Stores the raw input object
  #modelId // Stores the lowercased model ID
  #body // Stores the parsed body for InvokeModelCommand inputs
  #messages // Stores the messages for ConverseCommand inputs
  #isConverseCommand // Flag to distinguish between command types
