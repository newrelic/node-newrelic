...
class BedrockResponse {
  ...
  constructor({ response, bedrockCommand, isError = false }) {
    ...
    // Determine if it's a Bedrock Converse API response based on the command
    this.#isConverse = this.#command.isConverse
  ...
  get finishReason() {
    ...
    if (this.#isConverse) {
      // For Converse API, the stopReason is directly on the output object.
