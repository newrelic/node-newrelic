...
module.exports = class LlmErrorMessage {
   ...
   * @param {object} [params.agent] Details about the AI agent event if it was an AI agent event.
   * @param {boolean} [params.useNameAsCode] defaults to false, only Bedrock sets it to true so far
   */
  constructor({ response, cause, summary = {}, embedding = {}, vectorsearch = {}, tool = {}, agent = {}, useNameAsCode = false } = {}) {
