...
function NewRelicService(licenseKey, host, port) {
	if (!host) {
...
exports.createNewRelicService = function(licenseKey, host, port) {
  return new NewRelicService(licenseKey, host, port);
};
