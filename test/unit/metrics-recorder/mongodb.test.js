...
describe("record ParsedStatement with MongoDB", function() {
  ...
  describe("when scope is undefined", function() {
    ...
    it("should record no scoped metrics", function() {
      ...
      const result = [
        [{name: "Datastore/operation/MongoDB/find"}, [1, 0, 0, 0, 0, 0]],
        [{name: "Datastore/allWeb"}, [1, 0, 0, 0, 0, 0]],
        [{name: "Datastore/MongoDB/allWeb"}, [1, 0, 0, 0, 0, 0]],
        [{name: "Datastore/MongoDB/all"}, [1, 0, 0, 0, 0, 0]],
        [{name: "Datastore/all"}, [1, 0, 0, 0, 0, 0]],
        [{name: "Datastore/statement/MongoDB/users/find"}, [1, 0, 0, 0, 0, 0]],
      ]
  ...
  describe("with scope", function() {
    it("should record scoped metrics", function() {
      ...
      const result = [
        ...
        [{name: 'Datastore/MongoDB/allWeb'}, [1, 0.03, 0.002, 0.03, 0.03, 0.0009]],
        [{name: 'Datastore/MongoDB/all'}, [1, 0.03, 0.002, 0.03, 0.03, 0.0009]],
  ...
  it("should report exclusive time correctly", function() {
    ...
    const parent =
      root.add('Datastore/statement/MongoDB/users/find', makeRecorder('users', 'find'))

    const child1 = parent.add(
      'Datastore/statement/MongoDB/users/insert',
      makeRecorder('users', 'insert')
    )

    const child2 = child1.add(
      'Datastore/statement/MongoDB/cache/update',
    ...
    const result = [
      ...
      [{name: 'Datastore/MongoDB/allOther'}, [3, 0.053, 0.027, 0.005, 0.032, 0.001305]],
      [{name: 'Datastore/MongoDB/all'}, [3, 0.053, 0.027, 0.005, 0.032, 0.001305]],
