...
collectionTest('createIndex', async function createIndexTest(collection, verify) {
...
collectionTest('dropIndex', async function dropIndexTest(collection, verify) {
...
collectionTest('indexes', async function indexesTest(collection, verify) {
...
collectionTest('indexExists', async function indexExistsTest(collection, verify) {
  const data = await collection.indexExists(['_id_'])
  assert.equal(data, true)
  verify(null, [`${STATEMENT_PREFIX}/indexExists`], ['indexExists'], { strict: false })
})

collectionTest('indexInformation', async function indexInformationTest(collection, verify) {
