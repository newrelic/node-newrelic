...
common.assertChatCompletionMessages = function assertChatCompletionMessages({ tx, chatMsgs, id, model, reqContent, resContent }) {
  const baseMsg = {
...
common.assertChatCompletionSummary = function assertChatCompletionSummary({ tx, model, chatSummary, tokenUsage }) {
